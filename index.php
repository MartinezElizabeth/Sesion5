  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      let tabla1 = $("#tablaarticulos").DataTable({
        "ajax": { url: "php/articulos.php?accion=listar", dataSrc: "" },
      ...
      function recuperarDatosFormulario() {
        return { codigo: $('#Codigo').val(), descripcion: $('#Descripcion').val(), precio: $('#Precio').val() };
      }
      ...
      function agregarRegistro(registro) {
        $.ajax({
          ...
          data: registro,
          success: function(msg) { tabla1.ajax.reload(); },
          error: function() { alert("Hay un problema"); }
        });
      }
